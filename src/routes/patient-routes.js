...
import { createPatient, getPatientById, patientLogIn, getAllPatientHandler, deletePatientHandler, getDoctorInfoHandler,getBookedInfoHandler } from '../controller/patient-controller.js';
...
router.get('/bookedInfo', getBookedInfoHandler);
